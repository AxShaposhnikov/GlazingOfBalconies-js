...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])('timer', '2020-06-09');
...
var forms = function forms(state) {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      var formData = new FormData(item); //добавляем объект State котороый формируем из выбранных пользователем параметров
...
var timer = function timer(timerId, deadline) {
  ...
  var setClock = function setClock(selector, endTime) {
    var timer = document.getElementById(selector),
